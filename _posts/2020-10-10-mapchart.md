...
---
<p>
 <strong>MapChart</strong> is a freely available software package designed for drawing high-quality genetic linkage maps and displaying quantitative trait loci (QTLs). It helps researchers convert mapping data into clear, publication-ready diagrams, making it especially useful in genetics, genomics, and plant breeding studies.
</p>
<!--more-->

The software was developed at **Wageningen University & Research** by **Roeland E. Voorrips** and is widely used in genetic mapping studies for producing standardized graphs. It can be downloaded from [link](href=https://www.wur.nl/en/show/Mapchart.htms).
